package com.example.java8.fetures.immutableClassCreation;
...
using deep copy the HAshMap continue immutablr

but with shallow copy it s not immutable
...
public class FinalClassExample {
    ...
    public HashMap<String, String> getTestMap() {
        return testMap; // do not return actual object reference
...
//        hm.forEach((key, value) -> tempMap.put(key, hm.get(key)));
